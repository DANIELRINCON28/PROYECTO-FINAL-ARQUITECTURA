...
class ServiceFactory:
    ...
    def _create_optimization_service(self) -> Optional[RouteOptimizationPort]:
        """
        Crea o retorna el servicio de optimización.
    ...
    def create_optimization_service(self) -> Optional[RouteOptimizationService]:
        """
        Crea una instancia de RouteOptimizationService.
        
        Returns:
            RouteOptimizationService configurado, o None si no hay API key
            
        Example:
            >>> factory = ServiceFactory()
            >>> opt_service = factory.create_optimization_service()
            >>> if opt_service:
            >>>     optimized_route = opt_service.optimize_route(route_id)
        """
